...
    // === Sensor Pins (UPDATED) ===
    const IR_LEFT = DigitalPin.P2;
    const IR_MIDDLE = DigitalPin.P1;
    const IR_RIGHT = DigitalPin.P0; // <-- UPDATED to P0
    const IR_LEFT_ANALOG = AnalogPin.P2;
    const IR_MIDDLE_ANALOG = AnalogPin.P1;
    const IR_RIGHT_ANALOG = AnalogPin.P0;

    const ULTRASONIC_TRIG = DigitalPin.P8;
    const ULTRASONIC_ECHO = DigitalPin.P12;

    // === RGB Pins (UPDATED: P5=Red, P9=Green, P11=Blue) ===
    // BUZZER removed
    const RGB_RED = DigitalPin.P5;
    const RGB_GREEN = DigitalPin.P9;
    const RGB_BLUE = DigitalPin.P11;
...
    let Kp = 0.6, Ki = 0.0, Kd = 2.0; // Kd default lowered for stability
...
    // === Sensors Category (Moved to main Car Control category) ===
